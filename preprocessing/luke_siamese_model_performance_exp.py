...
def create_base_network(model_name='ResNet50'):
...
def create_siamese_network(model_name='ResNet50'):
...
def train_model(image_paths, identities, epochs=10, batch_size=32, learning_rate=1e-5, positive_pairs_per_person=1, seed=None, model_name='ResNet50'):
